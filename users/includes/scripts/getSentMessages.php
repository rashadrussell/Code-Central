...
$sql = mysql_query("SELECT toUser, fromUser, subject, message, date FROM messages WHERE fromUserId='$_SESSION[id]' ORDER BY date DESC");
...
xmlhttp.open("GET","getSentMessages.php?q="+str,true);
xmlhttp.send();
}
</script>

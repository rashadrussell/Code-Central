<?php
// There are two cdeC_db.php class files that were created; one in the includes folder and one in the classes folder. Fix this problem throughout the site.

if(file_exists('../cdeC_load.php')) {
require_once('../cdeC_load.php');
}
    class Database {
